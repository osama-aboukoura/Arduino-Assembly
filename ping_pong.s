...
main :	ldi r16,0 		; set register r16 to zero
        ...
        ; and thats because a register cannot hadle more than 4 bits
...
ldi r19, 5          ; time delay: keep the LED on for 50 ms (it gets updated in the last line of the routine)
...
; end of main code is here


; this is a method (or a function) that gets called within the program using the command: call
